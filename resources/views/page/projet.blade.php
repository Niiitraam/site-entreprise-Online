<section class="section-projet">
    ...
    <div class="element-projet">
        ...
        <ul>
            <a href="/projet1" class="lien-projet lien-cursor" data-src="{{secure_asset('image/projet/isabel-gomez.webp')}}">
                <p class="p1-projet">Isabel Gomez</p>
                <p class="p2-projet">Web development</p>
            </a>
            <a href="/projet2" class="lien-projet lien-cursor" data-src="{{secure_asset('image/projet/martin-design.webp')}}">
                <p class="p1-projet">Martin Manderveld</p>
                <p class="p2-projet">Intégration Web</p>
            </a>
            <a href="" class="lien-projet lien-cursor" data-src="{{secure_asset('image/projet/isabel-gomez.webp')}}">
