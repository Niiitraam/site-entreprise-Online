<section class="section-projet" id="project">
    <div class="element-projet">
        <div class="img-wrapper">
            <div class="img-placeholder"><img src="{{asset('image/projet/isabel-gomez.webp')}}" alt=""></div>
        </div>
        ...
        <ul>
            <a href="/Isabel-Gomez" class="lien-projet" data-src="{{asset('image/projet/isabel-gomez.webp')}}">
                <p class="p1-projet">Isabel Gomez</p>
                <p class="p2-projet">Web development</p>
            </a>
            <a href="/Renovation-DR" class="lien-projet" data-src="{{asset('image/projet/renovation.webp')}}">
                <p class="p1-projet">Rénovation DR</p>
                <p class="p2-projet">Web Design / Web development</p>
            </a>
            <a href="/Simon&Fils" class="lien-projet" data-src="{{asset('image/projet/renovation.webp')}}">
                <p class="p1-projet">Funérailles Simon & Fils</p>
                <p class="p2-projet">Web Design / Web development</p>
            </a>
            <a href="/Anne-Thiry" class="lien-projet" data-src="{{asset('image/projet/anne-thiry.webp')}}">
            ...
            <a href="/Scheerlinck" class="lien-projet" data-src="{{asset('image/projet/scheerlinck.webp')}}">
