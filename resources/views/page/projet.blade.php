<section class="section-projet" id="project">
    <div class="element-projet">
        ...
        <ul>
            ...
            <a href="/Renovation-DR" class="lien-projet" data-src="{{secure_asset('image/projet/renovation.png')}}">
                <p class="p1-projet">Rénovation DR</p>
                <p class="p2-projet">Web Design / Web development</p>
            </a>
            <a href="/Anne-Thiry" class="lien-projet" data-src="{{secure_asset('image/projet/anne-thiry.png')}}">
